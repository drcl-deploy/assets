...
IMPLICIT_WO_COUPLING_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        asset_path=str(asset_path("hector_v2", "feet", "mvmc_reduced.urdf")),
...
IMPLICIT_WO_COUPLING_SC_CFG.spawn.asset_path = str(
    asset_path("hector_v2", "feet", "mvsc_reduced.urdf")
)
...
# update the path to urdf file
IMPLICIT_W_COUPLING_SC_CFG.spawn.asset_path = str(
    asset_path("hector_v2", "feet", "mvsc_reduced.urdf")
)
