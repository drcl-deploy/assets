...
G1_BM_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=str(asset_path("g1", "g1_bm.urdf")),
...
G1_BM_HAND_MESH_CFG.spawn.asset_path = str(asset_path("g1", "g1_bm_hand_mesh.urdf"))
G1_BM_HAND_MESH_CFG.spawn.collider_type = "convex_decomposition"

G1_FLAT_0_HAND_CFG = G1_BM_CFG.copy()
G1_FLAT_0_HAND_CFG.spawn.asset_path = str(asset_path("g1", "g1_flat_0_hand.urdf"))
